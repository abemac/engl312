...
public class NewCust2 extends Layout{

	public NewCust2(Stage primaryStage) {
		super(primaryStage);
					...
					public void handle(ActionEvent event) {
						...
						next3.setOnAction(new EventHandler<ActionEvent>() {
							...
							public void handle(ActionEvent event) {
								...
								center.getChildren().remove(center.getChildren().size()-1);
								center.getChildren().remove(center.getChildren().size()-1);
								util.Sdata.customers.add(new Customer(custName){{setEmail(custEmail);setAddInfo(NewCust2.this.addInfo);}});
								...
								ok.setOnAction(new EventHandler<ActionEvent>() {
									...
									public void handle(ActionEvent event) {
							    		...
							    		CheckIn h= new CheckIn(primaryStage,true);
